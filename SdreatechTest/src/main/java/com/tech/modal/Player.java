...
@Table(name="PLAYER") // define table name for database
public class Player {
	...
	@NotBlank // playerName not null
	private String playerName;
	
	@Column(unique = true) // every email is unique
	@Email(regexp = "^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$") // email regExp
	...
	@ManyToOne // one team has a multiple player relation
	private Team team;
